  ...
  return (
    <div className="flex flex-col gap-6 w-full px-4 sm:px-0">
      ...
      <div className="mt-2 animate-in fade-in duration-300">
        ...
        {activeTab === "analytics" && (
          <section className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-border/40 pb-3">
                  ...
                  <span className="text-[9px] font-bold px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex items-center gap-0.5">
                    <ArrowUpRight className="size-3" />
                    +4.2%
                  </span>
                </div>
                <div className="flex justify-between items-baseline mt-1">
                  <span className="text-4xl font-extrabold text-white">84.5%</span>
              ...
              <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-border/40 pb-3">
                  <div className="flex items-center gap-2">
                    <Clock className="size-4.5 text-violet-400" />
                ...
                <div className="flex justify-between items-baseline mt-1">
                  <span className="text-4xl font-extrabold text-white">128m</span>
              ...
              <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-border/40 pb-3">
                  <div className="flex items-center gap-2">
                    <Flame className="size-4.5 text-red-400" />
                ...
                <div className="flex justify-between items-baseline mt-1">
                  <span className="text-4xl font-extrabold text-white">5 Days</span>
                  ...
                  {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((day, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex flex-col items-center gap-1">
                        <div className={cn("w-full h-2 rounded-full", isPracticed ? "bg-red-500" : "bg-slate-950")} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-border/40 pb-3">
                  <h4 className="text-xs font-bold text-white tracking-wide">Mock Accuracy Progression</h4>
                  <span className="text-[9px] text-muted-foreground font-bold">Last 5 Sessions</span>
                </div>
                <div className="relative w-full h-48 flex items-center justify-center">
                  <svg className="w-full h-full" viewBox="0 0 300 150">
                    {/* Grid Lines */}
                    <line x1="20" y1="20" x2="290" y2="20" stroke="rgba(255,255,255,0.04)" strokeDasharray="4 4" />
                    <line x1="20" y1="60" x2="290" y2="60" stroke="rgba(255,255,255,0.04)" strokeDasharray="4 4" />
                    <line x1="20" y1="100" x2="290" y2="100" stroke="rgba(255,255,255,0.04)" strokeDasharray="4 4" />
                    <line x1="20" y1="130" x2="290" y2="130" stroke="rgba(255,255,255,0.08)" />
                    ...
                    {/* Coordinates Dots */}
                    <circle cx="20" cy="130" r="3.5" fill="#a78bfa" stroke="#0f172a" strokeWidth="1" />
                    <circle cx="80" cy="110" r="3.5" fill="#a78bfa" stroke="#0f172a" strokeWidth="1" />
                    <circle cx="140" cy="80" r="3.5" fill="#f472b6" stroke="#0f172a" strokeWidth="1" />
                    <circle cx="200" cy="65" r="3.5" fill="#f472b6" stroke="#0f172a" strokeWidth="1" />
                    <circle cx="260" cy="40" r="4.5" fill="#38bdf8" stroke="#0f172a" strokeWidth="1.5" className="animate-ping pointer-events-none" />
                    <circle cx="260" cy="40" r="3.5" fill="#38bdf8" stroke="#0f172a" strokeWidth="1" />

                    {/* Labels */}
                    <text x="18" y="145" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">S1 (62%)</text>
                    <text x="78" y="145" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">S2 (68%)</text>
                    <text x="138" y="145" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">S3 (76%)</text>
                    <text x="198" y="145" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">S4 (80%)</text>
                    <text x="258" y="145" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">S5 (84%)</text>
              ...
              <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between border-b border-border/40 pb-3">
                  <h4 className="text-xs font-bold text-white tracking-wide">Weekly Practice Duration</h4>
                ...
                <div className="relative w-full h-48 flex items-center justify-center">
                  <svg className="w-full h-full" viewBox="0 0 300 150">
                    ...
                    <text x="35" y="82" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">20m</text>
                    <text x="38" y="142" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">Mon</text>

                    {/* Tue: 15m */}
                    <rect x="75" y="100" width="16" height="30" rx="4" fill="url(#barGrad1)" />
                    <text x="75" y="92" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">15m</text>
                    <text x="78" y="142" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">Tue</text>

                    {/* Wed: 30m */}
                    <rect x="115" y="70" width="16" height="60" rx="4" fill="url(#barGrad1)" />
                    <text x="115" y="62" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">30m</text>
                    <text x="118" y="142" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">Wed</text>

                    {/* Thu: 25m */}
                    <rect x="155" y="80" width="16" height="50" rx="4" fill="url(#barGrad1)" />
                    <text x="155" y="72" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">25m</text>
                    <text x="158" y="142" fill="rgba(255,255,255,0.4)" fontSize="8" fontWeight="bold">Thu</text>
                    ...
                    <text x="198" y="142" fill="rgba(255,255,255,0.6)" fontSize="8" fontWeight="bold">Fri</text>

                    {/* Sat: 0m */}
                    <rect x="235" y="127" width="16" height="3" rx="1" fill="rgba(255,255,255,0.06)" />
                    <text x="238" y="142" fill="rgba(255,255,255,0.3)" fontSize="8" fontWeight="bold">Sat</text>

                    {/* Sun: 0m */}
                    <rect x="275" y="127" width="16" height="3" rx="1" fill="rgba(255,255,255,0.06)" />
                    <text x="278" y="142" fill="rgba(255,255,255,0.3)" fontSize="8" fontWeight="bold">Sun</text>
            ...
            <div className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 shadow-sm flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3.5">
                <div className="flex gap-3.5 items-start p-4 rounded-xl bg-violet-500/5 border border-violet-500/10">
                  <Brain className="size-5 text-violet-400 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-white">Focus on Coding Scenarios</h4>
                ...
                <div className="flex gap-3.5 items-start p-4 rounded-xl bg-emerald-500/5 border border-emerald-500/10">
                  <Mic className="size-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-xs font-bold text-white">Pacing & Pause Control</h4>
                    <p className="text-[11px] text-muted-foreground leading-relaxed mt-1">
        ...
        {activeTab === "developer" && (
          <section className="border border-border bg-slate-900/30 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-sm flex flex-col md:flex-row gap-8 items-center md:items-start relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center gap-4 shrink-0">
              ...
              <div>
                <h3 className="text-lg font-extrabold text-white">Saurabh Anand</h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Next.js 15 App Router", "React 19", "Tailwind CSS v4", "Vapi AI Speech Integration", "Supabase DB & Postgres", "Clerk Authentication"].map((skill) => (
                    <span key={skill} className="px-2.5 py-1 bg-slate-950 border border-border text-[10px] font-bold rounded-lg text-muted-foreground">
                      {skill}
                    </span>
                  ))}
                </div>
