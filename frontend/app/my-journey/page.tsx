...
const Profile = async () => {
  ...
  return (
    <main className="min-lg:w-3/4 max-w-4xl mx-auto flex flex-col gap-8">
      ...
      <section className="relative overflow-hidden flex justify-between gap-6 max-sm:flex-col items-center max-sm:items-start border border-border/80 bg-card/45 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-md w-full">
        {/* Glow decorations */}
        ...
        <div className="flex gap-5 items-center flex-wrap relative z-10">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="font-extrabold text-2xl tracking-tight text-foreground bg-none">
        ...
        <div className="flex gap-4 flex-wrap max-sm:w-full max-sm:justify-between relative z-10">
          <div className="border border-border/70 bg-card/70 backdrop-blur-md rounded-2xl p-4 gap-1 flex flex-col min-w-[130px] shadow-xs group hover:border-primary/20 transition-all duration-300">
            ...
            <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mt-1.5">Sessions Done</div>
          </div>
          <div className="border border-border/70 bg-card/70 backdrop-blur-md rounded-2xl p-4 gap-1 flex flex-col min-w-[130px] shadow-xs group hover:border-primary/20 transition-all duration-300">
            <div className="flex gap-2 items-center">
            ...
            <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mt-1.5">My Companions</div>
          </div>
        </div>
      </section>
